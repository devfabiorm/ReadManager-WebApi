        ...
        public static LivroPaginado ToLivroPaginado(this IQueryable<LivroApi> query, LivroPaginacao paginacao)
        {
            ...
            return new LivroPaginado
            {
                ...
                Resultado = query
                    ...
                    .ToList(),
                Anterior = paginacao.Pagina > 1 ? $"livros?pagina={paginacao.Pagina - 1}&pagina={paginacao.Tamanho}" : "",
                Proximo = paginacao.Pagina < totalPaginas ? $"livros?pagina={paginacao.Pagina + 1}&pagina={paginacao.Tamanho}" : ""
            };
        }
    }
